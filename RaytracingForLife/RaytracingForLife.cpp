...
void PrintSampleImage(vector<PixelColor> &image) {
	int imgWidth = 256;
	int imgHeight = 256;
...
vector<double> ConvertToDoubleVector(const vector<PixelColor> &image) {
...
void SaveImage(const vector<double> &image, int imgWidth, int imgHeight, const string &filename) {
